...
mkdir -p $SCRATCH/CIRCexplorer2Results/RTT/HSA/$SAMPLE


# CIRCexplorer2 parse -t BWA \
#   $SCRATCH/bwa/RTT/HSA/$SAMPLE/bwa_mem_alignments.sam \
#   -b $SCRATCH/CIRCexplorer2Results/RTT/HSA/$SAMPLE/back_spliced_junction.bed \
#   > $SCRATCH/CIRCexplorer2Results/RTT/HSA/$SAMPLE/CIRCexplorer2_parse.log
...
CIRCexplorer2 annotate \
  ...
  -g $GENOME/genome.fa \
  -b $SCRATCH/CIRCexplorer2Results/RTT/HSA/$SAMPLE/back_spliced_junction.bed \
  -o $SCRATCH/CIRCexplorer2Results/RTT/HSA/$SAMPLE/circularRNA_known.txt \
  > $SCRATCH/CIRCexplorer2Results/RTT/HSA/$SAMPLE/CIRCexplorer2_annotate.log

# CIRCexplorer2 assemble \
#   -r $SCRATCH/GENOMES/mm10/refFlat.txt \
#   -m $SCRATCH/TopHatResults/RTT/HSA/c/tophat \
#   -o $SCRATCH/CIRCexplorer2Results/RTT/HSA/$SAMPLE/assemble \
#   > $SCRATCH/CIRCexplorer2Results/RTT/HSA/$SAMPLE/CIRCexplorer2_assemble.log

# CIRCexplorer2 denovo \
#   -r $SCRATCH/GENOMES/mm10/refFlat.txt \
#   -g $GENOME/genome.fa \
#   -b $SCRATCH/CIRCexplorer2Results/RTT/HSA/$SAMPLE/back_spliced_junction.bed \
#   -d $SCRATCH/CIRCexplorer2Results/RTT/HSA/$SAMPLE/assemble \
#   -m $SCRATCH/TopHatResults/RTT/HSA/$SAMPLE/tophat \
#   -o $SCRATCH/CIRCexplorer2Results/RTT/HSA/$SAMPLE/denovo
#   > $SCRATCH/CIRCexplorer2Results/RTT/HSA/$SAMPLE/CIRCexplorer2_denovo.log
